...
namespace DoAnWebQuanLyKhachSan.Service.Helpers
{
    public class HotelManagementBaseService : BaseService
    {
        public HotelManagementBaseService(HotelManagementRepository repository, IMapper mapper) : base(repository, mapper)
        {
